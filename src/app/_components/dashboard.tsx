      ...
      <div style={{
        ...
        {[
          ...
          <div key={idx} style={cardStyle}>
            <p style={{ color: TEXT_SUB, fontSize: "12px", fontWeight: 700, textTransform: "uppercase", marginBottom: "8px", letterSpacing: "0.5px" }}>
              {item.label}
            </p>
          ...
          {categories.map((c) => (
            <div key={c.name} style={cardStyle}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
                ...
                <span style={{ background: "#f0fdf4", color: "#166534", padding: "4px 10px", borderRadius: "10px", fontSize: "11px", fontWeight: 800 }}>
                  {c.name}
                </span>
              </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ borderBottom: `1px solid ${BORDER_COLOR}` }}>
                  <th style={{ padding: "16px", textAlign: "left", fontSize: "12px", fontWeight: 700, color: TEXT_SUB, textTransform: "uppercase" }}>วันที่</th>
                  <th style={{ padding: "16px", textAlign: "left", fontSize: "12px", fontWeight: 700, color: TEXT_SUB, textTransform: "uppercase" }}>รายการ</th>
                  <th style={{ padding: "16px", textAlign: "right", fontSize: "12px", fontWeight: 700, color: TEXT_SUB, textTransform: "uppercase" }}>จำนวนเงิน</th>
                </tr>
              </thead>
              <tbody>
                {transactions.map((t, index) => (
                  <tr key={index} style={{ borderBottom: `1px solid ${BG_COLOR}` }}>
                    ...
                    <td style={{
                      padding: "16px", textAlign: "right", fontSize: "15px", fontWeight: 700,
